...
//    public ObservableList<String> getSceneIdObservableList()	{return sceneIdObservableList;}
	...
	scenefile = defaultfs.getPath(System.getProperty("user.dir"),"rdj","scenes","default.scene");
	if (args.length>0){scenefile = defaultfs.getPath(System.getProperty("user.dir"),"rdj","scenes",args[0]);}
	launch(args);
    }
}
